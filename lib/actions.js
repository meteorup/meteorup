    ...
    if(err) {
      ...
      async.mapSeries(
        ...
        function (sessionData, callback) {
          ...
          var setttingsJsonPath = path.resolve(self.pwd, 'settings.json');
          var exists = fs.existsSync(setttingsJsonPath);
          var env = {};
          if (exists) {
            var setttingsJson = JSON.stringify(require(setttingsJsonPath));
