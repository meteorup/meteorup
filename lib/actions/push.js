...
exports.main = function(bundlePath, env, config) {
  ...
  deployAndVerify(taskList, appName, rootPath ,rootURL,rootPort, deployCheckWaitTime);
...
function deployAndVerify(taskList, appName, rootPath, rootURL,rootPort, deployCheckWaitTime) {
  // deploying
